...
@Component({
  ...
  template: `
  <article class="card-white hover-lift overflow-hidden unified-feed-card room-card" [attr.aria-label]="post.title" role="article" (mouseenter)="onHover(true)" (mouseleave)="onHover(false)">
